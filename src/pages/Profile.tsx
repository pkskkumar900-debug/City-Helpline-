    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <motion.div 
            whileHover={{ y: -5 }}
            className="glass-card rounded-3xl p-8 sticky top-24 relative overflow-hidden"
          >
            {/* Background Glow */}
            ...
            <div className="flex flex-col items-center text-center mb-8 relative z-10">
              <div className="relative group">
                ...
                <div className="relative h-28 w-28 bg-gray-900 rounded-full flex items-center justify-center shadow-2xl overflow-hidden border-2 border-gray-800">
                  {userProfile?.photoURL ? (
                    <img src={userProfile.photoURL} alt="Profile" className="h-full w-full object-cover" />
                  ) : (
                    <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-blue-400 to-purple-500">
              ...
              <div className="mt-4 px-4 py-1.5 bg-blue-500/10 rounded-full text-sm font-semibold text-blue-400 border border-blue-500/20 shadow-[0_0_15px_rgba(59,130,246,0.15)]">
            ...
            <div className="space-y-3 border-t border-gray-800/50 pt-8 relative z-10">
              {userProfile?.role === 'contributor' && (
                <Link to="/add-listing" className="group flex items-center gap-4 p-4 rounded-2xl hover:bg-white/5 text-gray-400 hover:text-white transition-all duration-300">
              ...
              {userProfile?.role === 'contributor' && (
                <button 
                  ...
                  className={`w-full group flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 ${activeTab === 'listings' ? 'bg-blue-600/10 text-white border border-blue-500/20' : 'hover:bg-white/5 text-gray-400 hover:text-white'}`}
                >
                  <div className={`p-2 rounded-xl transition-colors ${activeTab === 'listings' ? 'bg-blue-500 text-white' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-white'}`}>
              ...
              <button 
                ...
                className={`w-full group flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 ${activeTab === 'saved' ? 'bg-blue-600/10 text-white border border-blue-500/20' : 'hover:bg-white/5 text-gray-400 hover:text-white'}`}
              >
                <div className={`p-2 rounded-xl transition-colors ${activeTab === 'saved' ? 'bg-blue-500 text-white' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-white'}`}>
              ...
              <button 
                ...
                className={`w-full group flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 ${activeTab === 'settings' ? 'bg-blue-600/10 text-white border border-blue-500/20' : 'hover:bg-white/5 text-gray-400 hover:text-white'}`}
              >
                <div className={`p-2 rounded-xl transition-colors ${activeTab === 'settings' ? 'bg-blue-500 text-white' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-white'}`}>
              ...
              <button 
                ...
                className="w-full group flex items-center gap-4 p-4 rounded-2xl hover:bg-red-500/10 text-gray-400 hover:text-red-400 transition-all duration-300 mt-2"
              >
                <div className="p-2 rounded-xl bg-gray-800 text-gray-400 group-hover:bg-red-500/20 group-hover:text-red-400 transition-colors">
          ...
          {activeTab === 'settings' ? (
            ...
            <>
              <div className="flex items-center justify-between mb-8">
                ...
                <span className="bg-blue-500/10 text-blue-400 py-1.5 px-4 rounded-full text-sm font-semibold border border-blue-500/20 shadow-[0_0_15px_rgba(59,130,246,0.1)]">
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  {savedListings.map((listing, index) => (
                    <motion.div
                      ...
                      key={listing.id}
                      className="glass-card rounded-3xl p-5 flex flex-col sm:flex-row gap-6 hover:border-gray-600/50 transition-all duration-300 group"
                    >
                      <div className="w-full sm:w-48 h-48 sm:h-auto rounded-2xl overflow-hidden flex-shrink-0 bg-gray-900 relative">
                      ...
                      <div className="flex-grow flex flex-col justify-between py-2">
                        <div>
                          <div className="flex justify-between items-start gap-4">
                            <div>
                              <h3 className="text-xl font-bold text-white line-clamp-1 group-hover:text-blue-400 transition-colors">{listing.title}</h3>
                              <div className="flex items-center mt-2 space-x-3">
                                <div className="flex items-center bg-gray-800/80 px-2 py-1 rounded-lg">
                                ...
                                <div className="flex items-center text-gray-400 text-sm bg-gray-800/50 px-2 py-1 rounded-lg">
                        ...
                        <div className="flex items-center justify-end mt-6">
                          <Link to={`/listing/${listing.id}`} className="inline-flex items-center justify-center px-4 py-2 bg-white/5 hover:bg-blue-600 text-white text-sm font-semibold rounded-xl transition-all duration-300">
                            View Details
                ...
                <motion.div 
                  ...
                  className="glass-card rounded-3xl p-16 text-center border-dashed border-2 border-gray-700/50 relative overflow-hidden"
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center">
                    ...
                    <Link to="/search" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-2xl font-bold shadow-lg shadow-blue-500/25 transition-all hover:scale-105">
              ...
              {loading ? (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center">
                    ...
                    <Link to="/add-listing" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-2xl font-bold shadow-lg shadow-blue-500/25 transition-all hover:scale-105">
                      <PlusCircle className="h-5 w-5" />
