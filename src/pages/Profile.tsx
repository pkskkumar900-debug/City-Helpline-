        ...
        <div className="lg:col-span-1">
          <div className="glass-card rounded-2xl p-6 sticky top-24">
            <div className="flex flex-col items-center text-center mb-6">
              <div className="h-24 w-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mb-4 shadow-lg shadow-blue-500/20">
            ...
            <div className="space-y-2 border-t border-gray-700 pt-6">
              ...
              <button className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-gray-800/50 text-gray-300 hover:text-white transition-colors">
